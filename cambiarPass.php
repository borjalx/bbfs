            ...
            <section class="main">
                <article>
                    ...
                    <form class="formulario" action="" method="POST">
                        <label for="nueva">Nueva contraseña:</label> <br><input type="password" name="pass21" id="nueva"><br>
                        <label for="verificar2">Verificación contraseña:</label> <br><input type="password" name="pass22" id="verificar2"><br>
            ...
            <section class="main">
                <article>
                    ...
                    <form class="formulario" action="" method="POST">
                        ...
                        <label for="verificar">Verificar contraseña:</label> <br><input type="password" name="pass12" id="verificar"><br>
